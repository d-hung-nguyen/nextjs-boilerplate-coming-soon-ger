...
export default function Hero() {
	return (
		<section className="relative w-full h-svh overflow-hidden flex items-center justify-center bg-black">
			{/* Background Video */}
			...
			<div className="relative z-10 text-white text-center px-4 md:px-8 lg:px-16 xl:px-32">
				<div className="mb-6 flex justify-center">
					<Image src="/images/logo.svg" alt="Address Hotels + Resorts" width={200} height={100} className="h-50 w-auto" />
				</div>
				<Separator className="w-full mx-auto border-white border-b-1 mb-72" />
