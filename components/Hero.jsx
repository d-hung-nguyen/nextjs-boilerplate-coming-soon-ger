...
export default function Hero() {
	return (
		<>
			<section className="relative w-full h-svh overflow-hidden flex items-start justify-center ">
				{/*
				 Background Video */}

				<video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover object-center  brightness-80 z-0">
					<source
